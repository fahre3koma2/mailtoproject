    ...
    <form action="{{ $edit ? route('user.update', ['user' => encrypt($user->id)]) : route('user.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ $edit ? $user->name : old('name') }}">
            </div>
            <div class="form-group">
            ...
            {{--  <div class="form-group">
                ...
                <input type="text" class="form-control" id="unit" name="unit" value="{{ $edit ? $user->biodata->unit : old('unit') }}">
            </div>  --}}
            <div class="form-group">
                <label>Alamat</label>
                <input type="text" class="form-control" id="alamat" name="alamat" value="{{ $edit ? $user->biodata->alamat : old('alamat') }}">
            </div>
        </div>
        <!-- /.card-body -->
